...
plt.plot(N[200:], t1[200:], "kx")
plt.plot(x, a[0]*x**3+a[1]*x**2+a[2]*x+a[3],'b-')
plt.xscale("log")
plt.yscale("log")
...
plt.plot(N[200:], t2[200:], "kx")
plt.plot(x, c[0]*x**3+c[1]*x**2+c[2]*x+c[3],'b-')
plt.xscale("log")
plt.yscale("log")
...
plt.plot(N[200:], t3[200:], "kx")
plt.plot(x, e[0]*x**3+e[1]*x**2+e[2]*x+e[3],'b-')
plt.xscale("log")
plt.yscale("log")
